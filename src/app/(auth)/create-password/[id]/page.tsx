...
export default function CreatePassword({ params }: { params: { id: string } }) {
    ...
    return(
        <>
            <SignInPageHeader/>
            <div className="h-screen w-full bg-[url('/images/pngs/slider-two.png')] bg-no-repeat bg-cover bg-center flex items-center justify-center overflow-y-scroll text-black">
