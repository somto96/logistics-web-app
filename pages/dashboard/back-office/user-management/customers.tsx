...
import { CustomersMainView } from '@/components/BackOffice/UserManagement/Customers/CustomersMainView';
...
const Customers = () => {
  ...
  return (
    <>
      <Head>
        <title>User Management || Customers </title>
        <meta name="description" content="Customer's Dashboard (Admin's View)" />
